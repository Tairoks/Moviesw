# Generated by Django 4.2.6 on 2023-11-20 17:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(default='default.png', upload_to='movies/', verbose_name='Poster')),
                ('budget', models.PositiveIntegerField(default=0, help_text='million on US dollars', verbose_name='Budget')),
                ...
                ('genre', models.ManyToManyField(to='catalog.genre', verbose_name='Genres')),
            ],
            options={
                'verbose_name': 'Movie',
